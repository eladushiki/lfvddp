...
- A and B are symmetric datasets, distinguished by lepton flavor. Loaded inputs need not arrive pre-separated; arbitrary configuration cuts construct the comparison categories.
