...
runtag="test"
train_sizes=['1/2','1/4']#['1/8','1/4','1/2']##['4/5','1/2','100/101','1/16','1/4']#['1/4','1/8','1/16','4/5','1/2','13/30']#['1/2','1/4','1/16','4/5','1/2','4/5','100/101']
test_sizes=['1/2','1/4']#['1/8','1/4','1/2']##['1/15', '1/24','1/5','1/101','1/16','1/4']#['1/4','1/8','1/16','1/15', '1/24','13/30']#['1/2','1/4','1/16','1/15', '1/24','1/5','1/101']
number_of_signals = [100,200,300,400,500,600,700,800,900,1000]
walltime = "70:00:00"
save_walltime = "05:00"
remove = True
sample = "exp"
...
def submit_jobs(outdir,scriptsdir):
    for config_num in [13]:
        for sig in [0]:#number_of_signals:
            ...
            for i in range(len(train_sizes)):
                ...
                for jobid in range(N_jobs):
                    ...
                    cmd_TAU=f"/usr/local/anaconda/3.8/bin/python {scriptsdir}/new_training_crossentropy.py -j {jobid} -R {train_size} -B {test_size} -s {sig} -c {scriptsdir}/config{config_num}.json -o {outdir}/training_outcomes --seed {seed} "
                    cmd_TAU+=f"-t TAU -S {sample} --BDstr Bkg --SDstr Sig --BAstr Ref --smlpdf {pdf}"
                    ...
                    u.submit_job(fsubname,walltime=walltime,io=0,mem=4)
