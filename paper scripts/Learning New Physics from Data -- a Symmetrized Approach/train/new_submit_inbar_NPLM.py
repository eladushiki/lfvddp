...
runtag="test"
train_sizes=['1']#['1/2']#[#['4/5','1/2','100/101','1/16','1/4']#['1/4','1/8','1/16','4/5','1/2','13/30']#['1/2','1/4','1/16','4/5','1/2','4/5','100/101']
test_sizes=['1/100']#['1/2']##['1/15', '1/24','1/5','1/101','1/16','1/4']#['1/4','1/8','1/16','1/15', '1/24','13/30']#['1/2','1/4','1/16','1/15', '1/24','1/5','1/101']
number_of_signals = [5,6,7,8,9,10,11,12,15,20]
walltime = ["25:00:00"]
...
def submit_jobs(outdir,scriptsdir):
    for config_num in ["_NPLM_wc_None_S1"]:
        for sig in number_of_signals:
            #N_jobs = 2000 if sig==0 else 99
            N_jobs = 100 if config_num=="_NPLM_wc_None_S1" else 100
