...
def main(context: ExecutionContext) -> None:
    ...
    t_a_loss = train_model_for_tau(context, t_a_model, A_dataset, A_dataset + B_dataset)
    t_b_loss = train_model_for_tau(context, t_b_model, B_dataset, A_dataset + B_dataset)
