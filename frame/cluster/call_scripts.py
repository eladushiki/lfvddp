...
def run_remote_python(
    ...
    environment_variables["ENV_ACTIVATION_SCRIPT"] = str(environment_activation_script_abspath)    environment_variables["SCRIPT_RELPATH"] = str(python_script_relpath_from_workdir_at_cluster)
