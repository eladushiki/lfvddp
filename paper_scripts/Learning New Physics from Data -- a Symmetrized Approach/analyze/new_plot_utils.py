...
def Plot_Percentiles_ref(results_file:au.results, df, patience=1000, xmax=500000, ymax=300, ymin=0, title='', save=False, save_path='', file_name=''):
    '''
    ...
    results_file:  (au.results) results file
...
def plot_t_distribution(results_file:au.results, df, epoch = 500000,xmin=0, xmax=300, ymax=0.1, nbins=10, samples_to_take='all', colors = [], vlines=[], label='', add_z='', title='', save=False, save_path='', file_name=''):
    '''
...
def plot_t_2distributions(results_file1:au.results, results_file2:au.results, df, epoch=500000, xmin=0, xmax=300, ymax=0.1, nbins=10, colors1=[], colors2=[], alphas=[], labels=[0,0], title='', save=False, save_path='', file_name=''):
    '''
    Plot the histogram of the test scores for the toys in results_file1 and results_file2, and the target chi2 distribution.
    
    results_file1: (au.results) results file
    results_file2: (au.results) results file (for comparison)
    df:            (int) expected chi2 degrees of freedom. If df=0 or df=False, the chi2 distribution is not shown.
    epoch:         (int) epoch for which the test scores are plotted
    xmin:          (float) minimum value of the x-axis (in terms of t score).
    xmax:          (float) maximum value of the x-axis (in terms of t score).
...
def animated_t_distribution(results_file:au.results, df, epoch = 500000,xmin=0, xmax=300, nbins=10, samples_to_take='all', frames=300, repeat=False, label='', title='', save=False, save_path='', file_name=''):
    '''
...
def animated_t_2distributions(results_file1:au.results, results_file2:au.results, df, epoch = 500000,xmin=0, xmax=300, nbins=10, frames=300, repeat=False, label='', title='', save=False, save_path='', file_name=''):
    '''
