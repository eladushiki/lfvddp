...
Due to limited detector efficiency and selection effects, not all events that occur inside the detector are observed. Hence, the resulting collection of events that the detector produces is smaller.

Let the detector efficiency be a function
\begin{align*}
    \eta^i(\phi^i): \mathbb{R} \to [0,1] \\
    \eta(x): \mathbb{R}^k \to [0,1] \equiv \prod_{i=1}^k \eta^i(\phi^i).
\end{align*}

where \(\eta(x)\) denotes the probability that an event is detected.
