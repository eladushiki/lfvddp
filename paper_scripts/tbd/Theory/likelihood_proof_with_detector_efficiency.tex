...
\title{Generalizing the Symmetrized Likelihood Formalism with Detector Efficiency in \(\mathbb{R}^k\) and Uncertainty Propagation}
\author{}
\date{}
...
\bibitem{LastDDPpaper} Bressler, S., Savoray, I., \& Zurgil, Y. (2024). Learning new physics from data — a symmetrized approach. \emph{Physical Review D, 110}(9), 095004. \href{https://arxiv.org/abs/2401.09530}{arXiv:2401.09530}
\end{thebibliography}
