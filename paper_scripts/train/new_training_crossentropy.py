...
if sample_str=='exp':
    ...
    feature,target = prepare_training(exp,Bkg_Aux_str,Sig_Aux_str,Bkg_Data_str,Sig_Data_str,round(219087*float(Fraction(train_size))),round(219087*float(Fraction(test_size))),sig_events,seed,Scale,Norm, N_poiss)#,Sig_loc,Sig_scale)
print('after prepare')
