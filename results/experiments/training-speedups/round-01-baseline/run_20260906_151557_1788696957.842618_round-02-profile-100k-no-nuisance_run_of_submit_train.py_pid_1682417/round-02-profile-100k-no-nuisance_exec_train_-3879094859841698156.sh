...
#PBS -S /bin/bash
#PBS -j oe
#PBS -N round-02-profile-100k-no-nuisance
#PBS -q N
...
configure_container_environment() {
    ...
    export_container_variable LFVDDP_COMMIT_HASH "ff09ec40b7723d6bca14d12afa139d0bedd03fa6"
}
...
run_singularity exec  \
    ...
    --cleanenv \
    --pwd /app \
    --bind /storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups:/app,/cvmfs:/cvmfs/,/storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline/run_20260906_151557_1788696957.842618_round-02-profile-100k-no-nuisance_run_of_submit_train.py_pid_1682417:/app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline \
    "$SANDBOX_DIR" \
