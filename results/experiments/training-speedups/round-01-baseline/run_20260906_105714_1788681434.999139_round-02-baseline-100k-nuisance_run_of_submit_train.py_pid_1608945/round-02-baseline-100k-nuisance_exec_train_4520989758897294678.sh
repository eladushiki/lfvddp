...
#PBS -S /bin/bash
#PBS -j oe
#PBS -N round-02-baseline-100k-nuisance
#PBS -q N
...
run_singularity exec  \
    ...
    --cleanenv \
    --pwd /app \
    --bind /storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups:/app,/cvmfs:/cvmfs/,/storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline/run_20260906_105714_1788681434.999139_round-02-baseline-100k-nuisance_run_of_submit_train.py_pid_1608945:/app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline \
    "$SANDBOX_DIR" \
