...
configure_container_environment() {
    ...
    export_container_variable LFVDDP_COMMIT_HASH "9563dd32b6bdffb7db14eefad8f0a80554740681"
}
...
run_singularity exec  \
    ...
    --cleanenv \
    --pwd /app \
    --bind /storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups:/app,/cvmfs:/cvmfs/,/storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline/run_20260831_153517_1788179717.235185_round-01-baseline_run_of_submit_train.py_pid_566944:/app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline \
    "$SANDBOX_DIR" \
