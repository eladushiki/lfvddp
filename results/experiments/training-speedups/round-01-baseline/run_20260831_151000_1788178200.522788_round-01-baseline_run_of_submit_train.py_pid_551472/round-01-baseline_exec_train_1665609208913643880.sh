...
run_singularity exec  \
    ...
    --cleanenv \
    --pwd /app \
    --bind /storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups:/app,/cvmfs:/cvmfs/,/storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline/run_20260831_151000_1788178200.522788_round-01-baseline_run_of_submit_train.py_pid_551472:/app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline \
    "$SANDBOX_DIR" \
    python train/single_train.py --configs /app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline/configs --only-train
