...
#PBS -S /bin/bash
#PBS -j oe
#PBS -N round-02-profile-1m-nuisance
#PBS -q N
...
run_singularity exec  \
    ...
    --cleanenv \
    --pwd /app \
    --bind /storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups:/app,/cvmfs:/cvmfs/,/storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline/run_20260906_151614_1788696974.448145_round-02-profile-1m-nuisance_run_of_submit_train.py_pid_1683120:/app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline \
    "$SANDBOX_DIR" \
