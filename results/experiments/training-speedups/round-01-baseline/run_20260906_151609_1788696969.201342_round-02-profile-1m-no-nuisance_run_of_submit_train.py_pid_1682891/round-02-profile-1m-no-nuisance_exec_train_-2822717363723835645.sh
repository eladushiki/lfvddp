...
#PBS -S /bin/bash
#PBS -j oe
#PBS -N round-02-profile-1m-no-nuisance
#PBS -q N
...
run_singularity exec  \
    ...
    --cleanenv \
    --pwd /app \
    --bind /storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups:/app,/cvmfs:/cvmfs/,/storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline/run_20260906_151609_1788696969.201342_round-02-profile-1m-no-nuisance_run_of_submit_train.py_pid_1682891:/app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline \
    "$SANDBOX_DIR" \
