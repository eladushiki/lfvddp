...
#PBS -S /bin/bash
#PBS -j oe
#PBS -N round-02-baseline-100k-no-nuisance
#PBS -q N
...
configure_container_environment() {
    ...
    export_container_variable LFVDDP_COMMIT_HASH "28d755d793a2a45166f0ec11324f179b69ce0b2f"
}
...
run_singularity exec  \
    ...
    --cleanenv \
    --pwd /app \
    --bind /storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups:/app,/cvmfs:/cvmfs/,/storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline/run_20260906_105709_1788681429.544454_round-02-baseline-100k-no-nuisance_run_of_submit_train.py_pid_1608789:/app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-baseline \
    "$SANDBOX_DIR" \
