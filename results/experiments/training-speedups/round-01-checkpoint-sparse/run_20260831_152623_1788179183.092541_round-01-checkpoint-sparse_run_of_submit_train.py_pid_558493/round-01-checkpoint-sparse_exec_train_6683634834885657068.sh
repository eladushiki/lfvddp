...
#PBS -S /bin/bash
#PBS -j oe
#PBS -N round-01-checkpoint-sparse
#PBS -q N
...
export PATH="/cvmfs/atlas.cern.ch/repo/containers/sw/singularity/x86_64-el9/current/bin:$PATH"
...
configure_container_environment() {
    ...
    export_container_variable LFVDDP_COMMIT_HASH "7bb7cf04a850b07f6c3dde97e0b89731403a78ff"
}
...
run_singularity exec  \
    ...
    --cleanenv \
    --pwd /app \
    --bind /storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups:/app,/cvmfs:/cvmfs/,/storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups/results/experiments/training-speedups/round-01-checkpoint-sparse/run_20260831_152623_1788179183.092541_round-01-checkpoint-sparse_run_of_submit_train.py_pid_558493:/app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-checkpoint-sparse \
    "$SANDBOX_DIR" \
    python train/single_train.py --configs /app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-checkpoint-sparse/configs --only-train
