...
configure_container_environment() {
    ...
    export_container_variable LFVDDP_COMMIT_HASH "f28eace44621351eb90a95ce9de1810d0a1cecfb"
}
...
run_singularity exec  \
    ...
    --cleanenv \
    --pwd /app \
    --bind /storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups:/app,/cvmfs:/cvmfs/,/storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups/results/experiments/training-speedups/round-01-checkpoint-sparse/run_20260831_175146_1788187906.435524_round-01-checkpoint-sparse_run_of_submit_train.py_pid_700213:/app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-checkpoint-sparse \
    "$SANDBOX_DIR" \
