...
run_singularity exec  \
    ...
    --cleanenv \
    --pwd /app \
    --bind /storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups:/app,/cvmfs:/cvmfs/,/storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups/results/experiments/training-speedups/round-01-checkpoint-sparse/run_20260901_111919_1788250759.366805_round-01-checkpoint-sparse_run_of_submit_train.py_pid_928529:/app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-checkpoint-sparse \
    "$SANDBOX_DIR" \
