...
configure_container_environment() {
    ...
    export_container_variable LFVDDP_COMMIT_HASH "fbb85f2af7f96c4264538f9b254ea68a6fde9038"
}
...
run_singularity exec  \
    ...
    --cleanenv \
    --pwd /app \
    --bind /storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups:/app,/cvmfs:/cvmfs/,/storage/agrp/eladklig/SymmetrizedDDP/.worktrees/training-speedups/results/experiments/training-speedups/round-01-checkpoint-sparse/run_20260831_231005_1788207005.813779_round-01-checkpoint-sparse_run_of_submit_train.py_pid_774762:/app/.worktrees/training-speedups/results/experiments/training-speedups/round-01-checkpoint-sparse \
    "$SANDBOX_DIR" \
