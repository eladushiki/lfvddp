...
$j$ being a function, $D$ the sample dataset, $R$ the reference dataset and $y$ an indicator for which dataset the sample event is taken from (1 for $D$ and 0 for $R$), following \cite{Italian_no_1_Learning_New_Physics_from_a_Machine}.
